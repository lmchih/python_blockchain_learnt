...
class Blockchain:
    ...
    def load_data(self):
        try:
            with open('blockchain.txt', mode='r') as f:
                ...
                self.__open_transations = update_transactions
    ...
    def proof_of_work(self):
        ...
        while not Verification.valid_proof(
                self.__open_transations, last_hash, proof):
            proof += 1
        return proof
    ...
    def get_balance(self):
        ...
        open_tx_sender = [tx.amount
                          for tx in
                          self.__open_transations if tx.sender == participant]
    ...
    def add_transaction(self, recipient, sender, amount=1.0):
        ...
        if Verification.verify_transaction(transaction, self.get_balance):
            ...
            self.__open_transations.append(transaction)
            self.save_data()
            return True
        return False
    ...
    def mine_block(self):
        ...
        copied_transactions = self.__open_transations[:]
